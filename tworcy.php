...
document.getElementById('preloader').style.display="block";
  ...
  <div id="deska_mapaDolna"></div>
     ...
     <div id="zakladka_Forum"><a class="zakladki" href="http://forum.wichry-wojny.pl" target="_blank"></a></div>
...
<center><h2>Zespół gry Wichry Wojny</h2></center><br/>
<h3>- Twórcy:</h3>
<b>Michał Marcak</b>: główny programista php, pomysłodawca projektu, twórca silnika gry, admin bazy<br/>
<b>Rafał Kula</b>: główny grafik i designer, twórca layoutu strony, programista php<br/><br/>
<h3>- Beta-testerzy:</h3>
Po zakończonych testach wypiszemy tutaj wszystkich testerów, którzy przyczynili się do rozwoju gry<br/><br/>
<center>Jeśli chcesz wesprzeć twórców gry i otrzymać konto Sponsor, wejdź <a href="sponsor.php"><b>tutaj</b></a></center>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
         ...
         <div id="notes_kartka_logowanie">
          <div style="margin-left: 20px; margin-top: 50px; width: 170px; height: 180px;">
           Jeśli nie masz jeszcze konta, <a href="rejestracja.php" style="color: #3f0808;"><b>zarejestruj</b></a> się i dołącz do społeczności graczy ! 
