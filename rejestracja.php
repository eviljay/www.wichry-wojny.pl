...
<!-- koniec preloadera, poczÄ_tek strony gĹ_Ăłwnej -->
<!-- tĹ_o - stĂłĹ_, sÄ_ki, mapy, luger, zakĹ_adki -->
...
<div id="notes">
 <div id="notes_logo"></div>
   ...
   <div id="notes_srodek"> 
      <div id="notes_tekst">       <!-- gĹ_Ăłwna czÄ_Ĺ_Ä_ strony - tekst w notesie -->
...
Aby zarejestrować się w grze, musisz wybrać którą nacją grać!<br />
 Jeśli jeszcze nie wiesz jaką - podpowiemy Ci. <br/>Krótkie statystyki poniżej.<br />
...
<tr><td>Ilość graczy:</td><td>26</td><td>17</td></tr>
<tr><td>Suma punktów:</td><td>16033</td><td>21244</td></tr>
<tr><td>Średnia pkt na gracza:</td><td>617</td><td>1250</td></tr>
<tr><td>Najwyższy wynik:</td><td>3631</td><td>4439</td></tr>
<tr><td>Wybierz Świat:</td><td><select class="formy"  style="width: 100px;" name="swiat">
		<option value='1'>Świat 1</option>
		</select></td></tr> 
<tr><td>Wybierz nację:</td><td><select class="formy" style="width: 100px;" name="nacja">
...
<img src="pic.php?id=16">
  ...
  <b>Oświadczam, że zapoznałem się z <a  href="regulamin.php">regulaminem</a><br  />
 i zgadzam się na warunki tam zamieszczone</b>
...
<div style="text-align: left; padding-left: 10px;"><small><b>*</b> Pola obowiązkowe.<br />
<b>**</b> Pytanie i odpowiedź potrzebne są do generowania nowego hasła, jeśli stare zapomnisz.
 Jeżeli nie wpiszesz tych danych - nie będzie możliwe wygenerowanie nowego hasła dla Ciebie!<br /></small></div>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
         ...
         <div id="notes_kartka_logowanie">
          <div style="margin-left: 20px; margin-top: 50px; width: 170px; height: 180px;">
           Wypełnij formularz i czekaj na wiadomość zwrotną, którą dostaniesz na swoją skrzynkę <b>e-mail</b>. 
